      ...
      <div className="w-full max-w-sm rounded-lg border border-[var(--border)] bg-[var(--card)] p-8">
        ...
        {sent ? (
          <div className="mt-6 space-y-3">
            ...
            <Link
              href="/login"
              className="inline-flex w-full justify-center rounded-md border border-[var(--border)] px-4 py-2.5 text-sm font-semibold text-[var(--foreground)] hover:bg-[var(--muted-bg)]"
            >
              Back to sign in
            </Link>
          </div>
